...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="m-0 font-weight-bold text-info">Cadastrar Novo Anime</h5>
    </div>
  <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
            <label class="text-white">Banner do Anime</label>
            <div class="mb-4 d-flex justify-content-center">
                <img id="selectedImage" class="img-fluid mx-auto d-block w-100" src="{{ asset('animes/Kimetsu no Yaiba/5/banner.png') }}"
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
            ...
            <div class="form-group text-white">
                ...
                <textarea class="form-control rounded-0" name="descricao" rows="5" placeholder="Entre com a descrição do anime"></textarea>
            </div>
            <div class="form-group text-white">
                <label class="form-label" for="customFile">Banner do Anime</label>
