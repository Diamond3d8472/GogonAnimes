...
<div class="container">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h5 class="m-0 font-weight-bold text-info">Editar Episodio - {{$episodio[0]['num_ep']}}</h5>
    </div>
  <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <div class="form-group text-white">
                <label for="exampleFormControlInput1">Nome Do Anime</label>
                <input type="text" name="nome" class="form-control rounded-0" placeholder="Exemplo: Shingeki no kyojin" value="{{$episodio[0]['nome']}}">
            </div>
            <div class="form-group text-white">
                <label for="descricao">Descricão</label>
                <textarea class="form-control rounded-0" name="descricao" rows="5" placeholder="Entre com a descrição do anime">{{$episodio[0]['descricao']}}</textarea>
            </div>
        ...
        <label for="exampleFormControlInput1" class="text-dark">.</label>
            <a data-mdb-button-init data-mdb-ripple-init href="{{route('site.admin.animes')}}" class="btn btn-block btn-info btn-lg px-5" data-toggle="modal" data-target="#EditarCapa">Editar Banner</a>
            <a data-mdb-button-init data-mdb-ripple-init href="{{route('site.admin.animes')}}" class="btn btn-block btn-info btn-lg px-5" data-toggle="modal" data-target="#EditarBanner" type="submit">Editar Video</a>
